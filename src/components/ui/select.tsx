...
>(({ className, children, label, error, ...props }, ref) => (
  <div className="w-full">
    {label && (
      <label className="label-text mb-2 block text-[var(--color-text)]">
        {label}
      </label>
    )}
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "bg-transparent px-3 py-1 text-base outline-none md:text-sm",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-sm font-semibold text-[var(--color-text)]",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-[var(--color-teal-50)] focus:text-[var(--color-text)]",
