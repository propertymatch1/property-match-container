        ...
        <div className="mx-auto flex h-full max-w-2xl flex-col justify-center">
          ...
          <div className="mb-[var(--spacing-8)]">
            ...
            <div className="flex gap-[var(--spacing-3)]">
              ...
              <Button
                ...
                className="min-w-[44px] px-3"
              >
                <div className="h-5 w-5 rounded-full bg-gradient-to-br from-red-500 via-blue-500 via-green-500 via-yellow-500 to-purple-500" />
              </Button>
              <Button
                variant="secondary"
                size="md"
          ...
          <div className="flex justify-center">
            <Button
              ...
              className="min-w-[280px] tracking-wide uppercase"
            >
