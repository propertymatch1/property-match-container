  ...
  return (
    ...
    >
      ...
      <div className="decorative-desktop-only">
        ...
        <div className="absolute -top-32 -left-32 h-64 w-64 rounded-full bg-gradient-to-br from-[var(--sage-200)]/8 to-[var(--sage-300)]/4 blur-sm" />

        {/* Medium circle - top right */}
        <div className="absolute top-16 -right-24 h-48 w-48 rounded-full bg-gradient-to-bl from-[var(--sage-100)]/12 to-[var(--warm-200)]/6" />
        ...
        <div className="absolute -right-16 -bottom-16 h-40 w-56 rotate-12 transform rounded-full bg-gradient-to-tl from-[var(--sage-300)]/6 to-transparent" />
      </div>
      ...
      {variant === "prominent" && (
        <>
          ...
          <div className="decorative-desktop-only">
            ...
            <div className="absolute top-0 right-0 h-full w-1 origin-top rotate-12 transform bg-gradient-to-b from-transparent via-[var(--sage-400)]/20 to-transparent" />
