    ...
    <aside className="hidden w-60 flex-shrink-0 lg:block">
      <div className="sticky top-8 space-y-2">
        ...
        <div className="mb-4 px-4 py-3">
          <h2 className="text-sm font-semibold tracking-wide text-[var(--warm-500)] uppercase">
            Dashboard Sections
          </h2>
        </div>
          ...
          {sections.map((section) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex w-full items-center gap-3 rounded-lg px-4 py-3 text-left transition-all duration-[var(--transition-fast)]",
                  "hover:bg-[var(--warm-100)] focus-visible:ring-2 focus-visible:ring-[var(--sage-500)] focus-visible:outline-none focus-visible:ring-inset",
                  "min-h-[44px]", // Touch-friendly minimum height
                  isActive
                    ? "border-l-4 border-[var(--sage-500)] bg-[var(--sage-100)] text-[var(--sage-700)] shadow-sm"
                    : "border-l-4 border-transparent text-[var(--warm-600)] hover:text-[var(--warm-800)]",
                )}
              >
                <div
                  className={cn(
                    "rounded-lg p-2 transition-colors duration-[var(--transition-fast)]",
                    isActive
        ...
        {/* Decorative Element */}
        <div className="decorative-desktop-only mt-8 px-4">
